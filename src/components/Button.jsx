...
const Button = () => {
    ...
    return(
        <div>
            <button onClick={handleClick} className="fixed top-4 left-2 z-50 p-3 rounded-full bg-gray-200 dark:bg-gray-700 hover:scale-110 transition duration-300 ease-in-out shadow-lg animate-[pulse_2s_infinite]" title="cambiar tema">
